...
MainVerticalSplitter::MainVerticalSplitter(wxWindow* parent, TrackManager& trackManager)
    : wxSplitterWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxSP_3D | wxSP_LIVE_UPDATE)
{
    ...
    SplitVertically(new InspectorView(this), new MainHorizontalSplitter(this, trackManager), Constants::INSPECTOR_VIEW_WIDTH);
}
